...
in
  stdenv.mkDerivation rec {
    ...
    src = fetchurl {
      url = "https://ftp.exim.org/pub/exim/exim4/old/${pname}-${version}.tar.xz";
      #hash = "sha256-XfOLBC/6mpyNMbILyEgVWAcONhsG9ldghiKmKjJ63Lo=";
      hash = "sha256-BRhh/InwYgUWLxISn7fr/kczg7thlL+GQpUr/VAyknQ=";
    };
    patches = [
      ./dmarc.patch
    ];
    ...
    configurePhase = ''
      ...
      sed -i '
        s:SSL_OP_NO_TLSv1_1 == 0x00000400L: 1>2:g
      ' src/tls-openssl.c
